...
class STGCNBlock(nn.Module):
    def __init__(self, in_channels, out_channels, num_nodes, A_hat):
        ...
        self.odeg = ODEG(out_channels[-1], 4, A_hat, time=6)
...
# A_sp_wave =np.array([[1,0,0],[1,1,1],[0,0,1]])
# # A_se_wave =np.array([[1,0,0],[1,0,1],[0,0,1]])
#
# A_sp_wave=torch.from_numpy(A_sp_wave.astype(np.float32))
# net = ODEGCN(num_nodes=3,
#              num_features=1,
