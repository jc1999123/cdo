...
# parser.add_argument('--epochs', type=int, default=4000, help='train epochs')
...
parser.add_argument('--train-ratio', type=float, default=1, help='the ratio of training dataset')
parser.add_argument('--valid-ratio', type=float, default=0, help='the ratio of validating dataset')
...
parser.add_argument('--his-length', type=int, default=4, help='the length of history time series of input')
parser.add_argument('--pred-length', type=int, default=4, help='the length of target time series for prediction')
